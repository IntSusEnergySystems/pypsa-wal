...
| 6 | **Whether to reconcile the district-heating supply mix at all** (§6). Prior question for the TIMES modellers: is TIMES's 52 %-geothermal 2050 district heat a considered Walloon resource assessment or a placeholder? `RENGEO` appears from 2040 only and grows to 5.53 PJ. | DH results |
