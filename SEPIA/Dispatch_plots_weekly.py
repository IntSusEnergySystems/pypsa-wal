...
def plot_series_power(cluster, opt, sector_opt, planning_horizons,title):
...
def plot_series_heat(cluster, opt, sector_opt, planning_horizons,title):
    tech_colors = snakemake.params.plotting["tech_colors"]
    colors = tech_colors 
    tabs = pn.Tabs()
...
if __name__ == "__main__":
    ...
    plot_series_power(cluster, opt, sector_opt, planning_horizons,title="Power Dispatch")
    plot_series_heat(cluster, opt, sector_opt, planning_horizons,title="Heat Dispatch")